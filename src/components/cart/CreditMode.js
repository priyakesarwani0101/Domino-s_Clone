...
function CreditMode() {
  return (
    <div className='credit-card-main-pk'>
        <h3 className='credit-card-text-pk'>Pay using Credit Card</h3>
        <div className='credit-card-img-div-pk'>
            ...
            <div className='credit-cards-img-div-create-pk credit-third-img-pk'></div>
        ...
        <div className='credit-input-div-pk'>
          <div className='credit-no-expiry-div-pk'>
            <input className='card-no-inp-tag-pk' type='number' placeholder='CREDIT CARD NO'></input>
          </div>
